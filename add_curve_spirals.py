...
# UNDO needed for operator redo and therefore also to let the addobjecthelp appear!!!
    ...
    turns = IntProperty(default=11, min=1, max=1000, description="Length of Spiral in 360 deg")
    steps = IntProperty(default=111, min=2, max=1000, description="Number of Vertices per turn")
...
# EXO variables
    iRadius = FloatProperty(default=0.1, min=0.00, max=100.00, description="Interior Radius")
    eRadius = FloatProperty(default=1.0, min=0.00, max=100.00, description="Exterior Radius")
    slope = FloatProperty(default=11.11, min=0.00, max=1000.00, description="Expansion Slope")
    scale = FloatProperty(default=1.00, min=0.00, max=100.00, description="Scale")

# CORNU variables
    length = IntProperty(default=100, min=0, max=1000, description="Curve Length")
    resolution = IntProperty(default=1000, min=1, max=10000, description="Curve Resolution")
    epsilon = IntProperty(default=100, min=1, max=10000, description="Integral Resolution")
    scale = FloatProperty(default=1.0, min=0.10, max=100.00, description="Scale")
